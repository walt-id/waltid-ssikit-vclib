...
data class DataSelfDescription(
    ...
    @Json(serializeNull = false) override var credentialSubject: DataSelfDescriptionSubject?,
    @Json(serializeNull = false) override var credentialSchema: CredentialSchema? = null,
    @Json(serializeNull = false) override var proof: Proof? = null,
) : AbstractVerifiableCredential<DataSelfDescription.DataSelfDescriptionSubject>(type) {
    data class DataSelfDescriptionSubject(
    ...
    companion object : VerifiableCredentialMetadata(
        ...
        template = {
            DataSelfDescription(
                ...
                credentialSubject = DataSelfDescriptionSubject(
